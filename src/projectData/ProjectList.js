...
export const ProjectList = [
  {
    ...
    details: "BaselHack 2023 project. This was a 48 hour hackathon where we were given a challenge to solve. Our challenge was to create a website that would help people find colleagues within the organization to get together and have lunch. We were able to create a website that would allow users to just click a button and be matched up with someone else from the organization. This was a great experience because it was my first hackathon and I was able to work with a team of 9 other people. As one of two frontend developers, I worked with design to take wireframes from concept to code, and with backend to ensure the data was retrieved and displayed correctly.",
  },
  {
    id: 1,
    name: "OverLoad",
