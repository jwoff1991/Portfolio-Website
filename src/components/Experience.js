    ...
    <div className="experience">
      <VerticalTimeline lineColor="#3e497a">
        ...
        >
          ...
          <p>Found a passion within the technology space through ample encounters with software engineers</p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--education"
          date="2022-2023"
        ...
        >
          ...
          <p>Solidified passion for software engineering working closly witht the development team</p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--education"
          date="2023-Present"
        ...
        >
          ...
          <p>Jumped head first into an emmersive 24 week bootcamp covering various technologies and coding principles</p>
        </VerticalTimelineElement>
      </VerticalTimeline>
    </div>
  );
